...
const TEXT = {
    en: {
        ...
        tooltips: {
            ...
            disable_dynamic_prefetch: "Off preloads the next block for speed (default). Turn it on only if preloading or block switching runs out of VRAM.",
    ...
    zh: {
        ...
        tooltips: {
            ...
            disable_dynamic_prefetch: "默认关闭，允许提前加载下一层以提高速度；只有提前加载或切换层时显存不足，才建议开启。",
